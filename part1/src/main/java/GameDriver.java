...
public class GameDriver {
	public static void main(String[] args) {
		...
		// define moves for player monster
		...
		while ((!player.hasLost()) && (!enemy.hasLost())) {
			...
			// I changed these from int variables to Move object variables because it makes the program more efficient
